...
```{r PlotGC, echo = FALSE, fig.cap = 'Gamma-Count probability mass function by values of the dispersion index (DI).', fig.height = 1.7, fig.width = 6}

par(mfrow = c(1, 3), mar = c(2.6, 2.8, 1.2, 0.5), mgp = c(1.6, 0.6, 0))
source("Script4.R")
plot(dgc(y = 0:100, beta = out_gc1$root[1], alpha = out_gc1$root[2]),
     type = "h", main = "DI = 0.5", ylab = "Mass function", xlab = "y")
plot(dgc(y = 0:100, beta = out_gc2$root[1], alpha = out_gc2$root[2]),
     type = "h", main = "DI = 2", ylab = "Mass function", xlab = "y")
plot(dgc(y = 0:100, beta = out_gc3$root[1], alpha = out_gc3$root[2]),
     type = "h", main = "DI = 5", ylab = "Mass function", xlab = "y")
...
```{r comPoispmfplot, echo = FALSE, cache = TRUE, fig.cap = 'COM-Poisson probability mass function by values of the dispersion index (DI).', fig.height = 1.7, fig.width = 6}

source("Script3.R")
par(mfrow = c(1, 3), mar = c(2.6, 2.8, 1.2, 0.5), mgp = c(1.6, 0.6, 0))
plot_cmp(lambda = out_cp1$root[1], nu = out_cp1$root[2],
         title = "DI = 0.5")
plot_cmp(lambda = out_cp2$root[1], nu = out_cp2$root[2],
         title = "DI = 2")
plot_cmp(lambda = out_cp3$root[1], nu = out_cp3$root[2],
         title = "DI = 5")
...
##-------------------------------------------
marrangeGrob(c(plotsGC, plotsCP), ncol = 3, nrow = 2, top = "")
