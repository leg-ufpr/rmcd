...
Furthermore, this book-course and supplementary materials as `R` code
and data sets are available for the students on the web page
...
along with `R` code and worked examples.
